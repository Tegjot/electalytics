...
def convert_reduced_json(item):
        your_keys=['text','entities','contributors','coordinates','place','created_at','source','retweet_count','favorite_count','id_str','in_reply_to_status_id_str','in_reply_to_screen_name','in_reply_to_user_id_str','possibly_sensitive','scopes','retweeted']
        item={ your_key: item[your_key] for your_key in your_keys }
        #for python2.6 and others
        return item
